...
const flows: Flow[] = [
  {
    ...
    title: "입금: 메인넷에서 채널로",
    metric: "메인넷에서 채널로",
    summary: "메인넷 토큰을 에스크로에 잠그면 채널 안에 같은 양이 생깁니다.",
    nodes: [
      { icon: Wallet, label: "유저 지갑", sub: "메인넷 토큰 보유", layer: "mainnet" },
      { icon: LockKeyhole, label: "에스크로", sub: "1:1로 잠금", layer: "mainnet" },
      { icon: RefreshCw, label: "Indexer와 Operator", sub: "입금 감지와 정산", layer: "glue" },
      { icon: Layers3, label: "채널 노드", sub: "동일량 mint", layer: "channel" },
      { icon: WalletCards, label: "채널 잔액", sub: "즉시 사용 가능", layer: "channel" },
    ],
    steps: [
      "유저가 메인넷 에스크로에 토큰을 잠급니다.",
      "Indexer가 입금 이벤트를 감지합니다.",
      "Operator가 정산 트랜잭션을 채널로 보냅니다.",
  ...
  },
  {
    ...
    title: "출금: 채널에서 메인넷으로",
    metric: "채널에서 메인넷으로",
    summary: "채널에서 burn한 만큼 메인넷 에스크로에서 실제 자산이 풀립니다.",
    nodes: [
      { icon: Flame, label: "Withdraw", sub: "채널에서 burn", layer: "channel" },
      { icon: RefreshCw, label: "Indexer와 Operator", sub: "SMT 증명 구성", layer: "glue" },
      { icon: LockKeyhole, label: "에스크로", sub: "증명 검증 후 방출", layer: "mainnet" },
      { icon: Wallet, label: "유저 지갑", sub: "메인넷 수령", layer: "mainnet" },
    ],
    steps: [
      "유저가 채널에서 토큰을 burn 합니다.",
      "Indexer가 출금 이벤트를 감지합니다.",
      "Operator가 nonce에 대한 SMT 증명을 구성합니다.",
      "에스크로가 증명을 검증하고 자산을 방출합니다.",
      "유저가 메인넷 지갑으로 자산을 수령합니다.",
    ],
  },
];
