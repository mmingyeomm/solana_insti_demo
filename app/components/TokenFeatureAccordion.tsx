...
const features = [
  {
    ...
    title: "Transfer Hook",
    label: "외부 검증",
    summary: "전송 직전에 기관이 정한 검증 로직을 실행합니다.",
  ...
  },
  {
    ...
    title: "Memo Required",
    label: "식별자 필수",
    summary: "감사와 대사에 필요한 거래 참조값을 전송에 남깁니다.",
  ...
  },
  {
    ...
    label: "금액 비공개",
    summary: "금액 공개 범위를 제한하고 허용된 참여자만 확인할 수 있게 합니다.",
  ...
  },
  {
    ...
    title: "Transfer Fee",
    label: "수수료 정책",
    summary: "전송마다 수수료를 계산하고 지정한 수취처로 분리합니다.",
  ...
  },
  {
    ...
    label: "이자율 정책",
    summary: "토큰 잔액에 적용할 이자율 조건을 정합니다.",
  ...
  },
  {
    ...
    label: "운영 권한",
    summary: "지정 권한자가 예외 상황에서 필요한 조치를 실행합니다.",
...
const featureGroups = [
  {
    ...
    icon: ShieldCheck,
    eyebrow: "전송 단계 통제",
    title: "컴플라이언스를 토큰 전송 정책으로 내재화합니다.",
  ...
  },
  {
    ...
    icon: EyeOff,
    eyebrow: "정보 공개 범위 제어",
    title: "거래 기록은 남기되 금액은 필요한 주체에게만 공개합니다.",
  ...
  },
  {
    ...
    icon: Percent,
    eyebrow: "운영 로직 대체",
    title: "이자와 수수료 로직을 토큰 자체에 내장합니다.",
